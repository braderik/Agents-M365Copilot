...
export const reportTools: Tool[] = [
  {
    ...
    description:
      "Download a Dynamics 365 F&O customer invoice as a PDF document. " +
  ...
  },
  {
    ...
    description:
      "Download any Dynamics 365 F&O SSRS report by name with custom parameters. " +
...
async function downloadViaAction(
  client: DynamicsClient,
  toolName: string,
  ...
  try {
    ...
    }) as { fileContent?: string; fileName?: string; error?: string } | null;
