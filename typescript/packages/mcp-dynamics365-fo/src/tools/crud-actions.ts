...
const UpdateRecordSchema = z.object({
  ...
  method: z.enum(["PATCH", "PUT"]).default("PATCH").describe(
    "PATCH = partial update (default). PUT = full replacement."
  ),
});
...
const CallActionSchema = z.object({
  actionName: z.string().describe(
    "OData action name. Can include namespace (e.g. Microsoft.Dynamics.DataEntities.ConfirmOrder) " +
...
const CallJsonServiceSchema = z.object({
  servicePath: z.string().describe(
    "Relative service path, e.g. api/services/SalesService/SalesOrderService/createSalesOrder"
  ),
...
export const crudActionTools: Tool[] = [
  {
    name: "d365_create_record",
    description:
      "Create a new record in any Dynamics 365 F&O entity set. " +
  ...
  },
  {
    ...
    description:
      "Update an existing Dynamics 365 F&O record. " +
  ...
  },
  {
    ...
    description:
      "Delete a record from a Dynamics 365 F&O entity set by its key. " +
  ...
  },
  {
    ...
    description:
      "Execute a Dynamics 365 F&O OData action or function. " +
    ...
    inputSchema: {
      ...
      properties: {
        actionName: {
          type: "string",
          description:
            "Action name, e.g. 'ConfirmOrder' or 'Microsoft.Dynamics.DataEntities.ConfirmOrder'",
        },
        parameters: {
          type: "object",
  ...
  },
  {
    ...
    description:
      "Call a Dynamics 365 F&O JSON service API endpoint. " +
  ...
  },
  {
    ...
    description:
      "Test connectivity to the Dynamics 365 F&O instance and return latency and status.",
    inputSchema: {
      type: "object",
      properties: {},
    },
  },
  {
    ...
    description:
      "Get D365 F&O environment details including base URL, OData endpoint, default company, and connection status.",
    inputSchema: {
      type: "object",
      properties: {},
    },
...
export async function handleCrudActionTool(
  name: string,
  args: Record<string, unknown>,
  client: DynamicsClient,
  config: { baseUrl: string; defaultCompany?: string },
  ...
  switch (name) {
    ...
    case "d365_update_record": {
      ...
      try {
        await client.update({
          entitySet: a.entitySet,
          key: a.key as string | Record<string, string>,
          data: a.data,
          method: a.method,
        });
        return {
    ...
    case "d365_delete_record": {
      ...
      try {
        await client.delete(a.entitySet, a.key as string | Record<string, string>);
        return {
          type: "text",
    ...
    case "d365_call_action": {
      ...
      try {
        const result = await client.callAction({
          ...
          entitySet: a.entitySet,
          entityKey: a.entityKey as string | Record<string, string> | undefined,
        });
