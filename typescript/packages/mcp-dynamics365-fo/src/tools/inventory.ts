...
export const inventoryTools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Query on-hand inventory quantities in Dynamics 365 F&O by item, warehouse, and site.",
    inputSchema: {
      type: "object",
      properties: {
        itemNumber: { type: "string" },
  ...
  },
  {
    ...
    description:
      "Query inventory transactions (movements) in Dynamics 365 F&O by item, warehouse, type, and date.",
    inputSchema: {
      type: "object",
      properties: {
        itemNumber: { type: "string" },
...
export async function handleInventoryTool(
  ...
  switch (name) {
    case "inv_query_items": {
      ...
      if (a.itemNumber) filters.push(`contains(ItemNumber,'${a.itemNumber}')`);
      if (a.productName) filters.push(`contains(SearchName,'${a.productName}')`);
      if (a.itemType) filters.push(`ItemType eq '${a.itemType}'`);
    ...
    case "inv_get_item": {
      ...
      try {
        const key: Record<string, string> = { ItemNumber: a.itemNumber };
    ...
    case "inv_query_onhand": {
      ...
      if (a.warehouseId) filters.push(`InventWarehouseId eq '${a.warehouseId}'`);
      if (a.siteId) filters.push(`InventSiteId eq '${a.siteId}'`);
      if (a.minQty !== undefined) filters.push(`AvailablePhysicalQuantity ge ${a.minQty}`);
      if (a.dataAreaId) filters.push(`DataAreaId eq '${a.dataAreaId}'`);
    ...
    case "inv_query_warehouses": {
      ...
      const filters: string[] = [];
      if (a.warehouseId) filters.push(`WarehouseId eq '${a.warehouseId}'`);
      if (a.siteId) filters.push(`SiteId eq '${a.siteId}'`);
      if (a.dataAreaId) filters.push(`DataAreaId eq '${a.dataAreaId}'`);
    ...
    case "inv_query_movements": {
      ...
      if (a.itemNumber) filters.push(`ItemNumber eq '${a.itemNumber}'`);
      if (a.warehouseId) filters.push(`InventWarehouseId eq '${a.warehouseId}'`);
      if (a.transType) filters.push(`TransType eq '${a.transType}'`);
    ...
    case "inv_query_transfer_orders": {
      ...
      const filters: string[] = [];
      if (a.transferOrderNumber) filters.push(`TransferId eq '${a.transferOrderNumber}'`);
      if (a.fromWarehouse) filters.push(`InventLocationIdFrom eq '${a.fromWarehouse}'`);
      if (a.toWarehouse) filters.push(`InventLocationIdTo eq '${a.toWarehouse}'`);
      if (a.status) filters.push(`TransferStatus eq '${a.status}'`);
      if (a.dateFrom) filters.push(`ShipDate ge ${a.dateFrom}`);
      if (a.dateTo) filters.push(`ShipDate le ${a.dateTo}`);
      if (a.dataAreaId) filters.push(`DataAreaId eq '${a.dataAreaId}'`);
    ...
    case "inv_query_item_prices": {
      ...
      const filters: string[] = [];
      if (a.itemNumber) filters.push(`ItemNumber eq '${a.itemNumber}'`);
      if (a.priceType) filters.push(`PriceType eq '${a.priceType}'`);
      if (a.dataAreaId) filters.push(`DataAreaId eq '${a.dataAreaId}'`);
