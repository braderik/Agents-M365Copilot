...
// ─── Tool definitions ─────────────────────────────────────────────────────────
export const advancedQueryTools = [
    {
        name: "d365_query_entity",
        description: "Execute a flexible OData query against ANY Dynamics 365 F&O entity set. " +
    ...
    },
    {
        ...
        description: "Fetch a single Dynamics 365 F&O record by its OData key. " +
    ...
    },
    {
        ...
        description: "Discover all available OData entity sets in the Dynamics 365 F&O instance. " +
    ...
    },
    {
        ...
        description: "Execute up to 20 Dynamics 365 F&O entity queries in a single HTTP round-trip. " +
    ...
    {
        name: "d365_fetch_all",
        description: "Fetch ALL pages of a Dynamics 365 F&O OData query using automatic server-driven pagination. " +
...
// ─── Handlers ─────────────────────────────────────────────────────────────────
export async function handleAdvancedQueryTool(name, args, client) {
    switch (name) {
        ...
        case "d365_get_entity_by_key": {
            ...
            try {
                const result = await client.getByKey(a.entitySet, a.key, { select: a.select, expand: a.expand });
        ...
        case "d365_list_entities": {
            try {
                ...
                return {
                    type: "text",
                    text: JSON.stringify({ entityCount: entities.length, entities: entities.sort() }, null, 2),
                };
            }
            catch (err) {
        ...
        case "d365_batch_query": {
            ...
            try {
                const results = await client.batchQuery(a.requests.map((r) => ({
        ...
        case "d365_fetch_all": {
            ...
            try {
                ...
                return {
                    type: "text",
                    text: JSON.stringify({ entitySet: a.entitySet, totalFetched: records.length, records }, null, 2),
                };
            }
            catch (err) {
...
//# sourceMappingURL=advanced-query.js.map